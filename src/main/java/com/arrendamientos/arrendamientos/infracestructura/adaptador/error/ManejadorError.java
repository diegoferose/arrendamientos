package com.arrendamientos.arrendamientos.infracestructura.adaptador.error;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        CODIGOS_ESTADO.put(excepcioValorNoNumerico.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
    }
